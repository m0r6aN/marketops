...
| 4 | Draft Marketing Content / Write Engaging Content | ready-for-review | `feat/marketops-04-content-workspace` | pending | 23 tests, typecheck, lint, Webpack production build, diff check, runtime smoke, dependency audit, and focused security review passed | Open and review the Capability 4 draft PR |
